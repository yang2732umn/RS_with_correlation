//this file want it to do 27 movie, 100 user, 0.8 missing, caseg5_s041~caseg5_s041 series of simulation for novariance, L1 and TLP
...
int main(){
    //novariance first
    string trainname("../simulation/rep100_prop/trainsim100_30_0.8_o2_caseg5_s041_2.txt");
    ...
    string tunename("../simulation/rep100_prop/tunesim100_30_0.8_o2_caseg5_s041_2.txt");
    string testname("../simulation/rep100_prop/testsim100_30_0.8_o2_caseg5_s041_2.txt");
    string traintunename("../simulation/rep100_prop/traintunesim100_30_0.8_o2_caseg5_s041_2.txt");
    string dname2("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s041_2.txt");
    string dname3("../simulation/rep100_prop/simdata_TLP_100_30_0.8_o2_caseg5_s041_2.txt");
    
    string name3("../simulation/rep100_prop/moviesim100_30_0.8_o2_caseg5_s041_2.txt");
    MatrixXd movie=readgn(name3);
    string name4("../simulation/rep100_prop/usersim100_30_0.8_o2_caseg5_s041_2.txt");
    MatrixXd users=readgn(name4);
    
    string alphaname("../simulation/rep100_prop/alphasim_100_30_0.8_o2_caseg5_s041_2.txt");
    MatrixXd mualpha=readgn(alphaname);
    string betaname("../simulation/rep100_prop/betasim_100_30_0.8_o2_caseg5_s041_2.txt");
    MatrixXd mubeta=readgn(betaname);
    
    string alphatruename("../simulation/rep100_prop/alpha_true100_30_0.8_o2_caseg5_s041_2.txt");
    string betatruename("../simulation/rep100_prop/beta_true100_30_0.8_o2_caseg5_s041_2.txt");
    ...
    vector<MatrixXd> testM=readgn_seq("../simulation/rep100_prop/Sigmatest100_30_0.8_o2_caseg5_s041_2.txt",test.user.size());
    ...
    string pathAndNamenovariancetune("../simulation/rep100_prop/sim100_30_0.8_o2_caseg5_s041_2_10Omega_tune_novariance_p1.txt");
    ...
    tstartall = time(0);
     ...
     //mualpha=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s041_2_300_alpha_novariance.txt");
     //mubeta=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s041_2_300_beta_novariance.txt");
     MatrixXd bestalphano=mualpha,bestbetano=mubeta;
     //mualpha=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s041_2_5_0.1_5_alpha.txt");
     //mubeta=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s041_2_5_0.1_5_beta.txt");
     ...
     //Omegais1=readgn_seq("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s041_2_5_0.1_5_Omega.txt",n);
     //current mualpha and mubeta are best from novariance
     //next is L1
     
     vector<MatrixXd> bestOmegais;
    
     //MatrixXd Omega1true=readgn("../simulation/rep100_prop/Omega1_true100_30_0.8_o2_caseg5_s041_2.txt");
     //MatrixXd Omega2true=readgn("../simulation/rep100_prop/Omega2_true100_30_0.8_o2_caseg5_s041_2.txt");
     ...
     //get_matricestoData(Omegais_true,"../simulation/rep100_prop/Omegais_true100_30_0.8_o2_caseg5_s041_2.txt");
     ...
     string pathAndNameL1tune("../simulation/rep100_prop/sim100_30_0.8_o2_caseg5_s041_2_10Omega_estvar_L1_tune_p1_3.txt");//tune in last is real tune
...
//next TLP, bestalpha and bestbeta and bestOmegais are current best from L1
 ...
 c=0.02;//0.1
 string pathAndNameTLPtune("../simulation/rep100_prop/sim100_30_0.8_o2_caseg5_s041_2_10Omega_estvar_TLP_tune_p1.txt");
 ...
 T.maxIter=3000;
 T.x=train;
 //T.realpha="simdata_100_30_0.8_o2_caseg5_s041_TLP_alpha.txt";
 T.movie=movie;
 T.users=users;
 ...
 bestalpha=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s041_2_10_1_0.5_alpha.txt");//start from what gives the smaller wMSE
 bestbeta=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s041_2_10_1_0.5_beta.txt");
 bestu=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s041_2_10_1_0.5_u.txt");
 bestu2=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s041_2_10_1_0.5_u2.txt");
 besttheta=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s041_2_10_1_0.5_theta.txt");
 besttheta2=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s041_2_10_1_0.5_theta2.txt");
 bestOmegais=readgn_seq("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s041_2_10_1_0.5_Omega.txt",n);
 bestZis=readgn_seq("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s041_2_10_1_0.5_Z.txt",n);
 bestUis=readgn_seq("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s041_2_10_1_0.5_U.txt",n);
...
/*if(remove(trainname.c_str())!=0||remove(tunename.c_str())!=0||remove(testname.c_str())!=0||remove(traintunename.c_str())!=0
 ||remove(name3.c_str())!=0||remove(name4.c_str())!=0||remove("alphasim_100_30_0.8_o2_caseg5_s041_2.txt")!=0||remove("betasim_100_30_0.8_o2_caseg5_s041_2.txt")!=0
 ||remove(alphatruename.c_str())!=0||remove(betatruename.c_str())!=0||remove("Sigmatune100_30_0.8_o2_caseg5_s041_2.txt")!=0
 ||remove("Sigmatest100_30_0.8_o2_caseg5_s041_2.txt")!=0||remove("Cortrain100_30_0.8_o2_caseg5_s041_2.txt")!=0
 ||remove("Omega1_true100_30_0.8_o2_caseg5_s041_2.txt")!=0||remove("Omega2_true100_30_0.8_o2_caseg5_s041_2.txt")!=0
 ||remove("Omegais_true100_30_0.8_o2_caseg5_s041_2.txt")!=0) perror("Error deleting file\n");*/
