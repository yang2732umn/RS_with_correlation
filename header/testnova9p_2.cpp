//this file want it to do 27 movie, 100 user, 0.8 missing, caseg6_s01~caseg6_s01 series of simulation for novariance, L1 and TLP
...
int main(){
    ...
    tstartall = time(0);
     ...
     //mualpha=readgn("../simulation/rep100_prop/simdata_100_100_0.85_o2_caseg6_s01_2_5_0.1_5_alpha.txt");
     //mubeta=readgn("../simulation/rep100_prop/simdata_100_100_0.85_o2_caseg6_s01_2_5_0.1_5_beta.txt");
     ...
     //Omegais1=readgn_seq("../simulation/rep100_prop/simdata_100_100_0.85_o2_caseg6_s01_2_5_0.1_5_Omega.txt",n);
     //current mualpha and mubeta are best from novariance
     //next is L1
     
     vector<MatrixXd> bestOmegais;
    
     //MatrixXd Omega1true=readgn("../simulation/rep100_prop/Omega1_true100_100_0.85_o2_caseg6_s01_2.txt");
     //MatrixXd Omega2true=readgn("../simulation/rep100_prop/Omega2_true100_100_0.85_o2_caseg6_s01_2.txt");
     ...
     //get_matricestoData(Omegais_true,"../simulation/rep100_prop/Omegais_true100_100_0.85_o2_caseg6_s01_2.txt");
...
//next TLP, bestalpha and bestbeta and bestOmegais are current best from L1
 ...
 c=0.02;//0.1
 string pathAndNameTLPtune("../simulation/rep100_prop/sim100_100_0.85_o2_caseg6_s01_2_40Omega_estvar_TLP_tune_p1.txt");
 ...
 T.maxIter=3000;
 T.x=train;
 //T.realpha="simdata_100_100_0.85_o2_caseg6_s01_TLP_alpha.txt";
 T.movie=movie;
 T.users=users;
 ...
 //bestalpha=readgn("../simulation/rep100_prop/simdata_100_100_0.85_o2_caseg6_s01_2_10_1_1_alpha.txt");//start from what gives the smaller wMSE
 //bestbeta=readgn("../simulation/rep100_prop/simdata_100_100_0.85_o2_caseg6_s01_2_10_1_1_beta.txt");
 //bestu=readgn("../simulation/rep100_prop/simdata_100_100_0.85_o2_caseg6_s01_2_10_1_1_u.txt");
 //bestu2=readgn("../simulation/rep100_prop/simdata_100_100_0.85_o2_caseg6_s01_2_10_1_1_u2.txt");//
 //besttheta=readgn("../simulation/rep100_prop/simdata_100_100_0.85_o2_caseg6_s01_2_10_1_1_theta.txt");
 //besttheta2=readgn("../simulation/rep100_prop/simdata_100_100_0.85_o2_caseg6_s01_2_10_1_1_theta2.txt");
 //bestOmegais=readgn_seq("../simulation/rep100_prop/simdata_100_100_0.85_o2_caseg6_s01_2_10_1_1_Omega.txt",n);
 //bestZis=readgn_seq("../simulation/rep100_prop/simdata_100_100_0.85_o2_caseg6_s01_2_10_1_1_Z.txt",n);
 //bestUis=readgn_seq("../simulation/rep100_prop/simdata_100_100_0.85_o2_caseg6_s01_2_10_1_1_U.txt",n);
