...
int main(){
    ...
    string tunename("../simulation/rep100_prop/tunesim100_100_0.85_o2_caseg6_s021_2.txt"); 
    string testname("../simulation/rep100_prop/testsim100_100_0.85_o2_caseg6_s021_2.txt");
    string traintunename("../simulation/rep100_prop/traintunesim100_100_0.85_o2_caseg6_s021_2.txt");
    string dname2("../simulation/rep100_prop/simdata_100_100_0.85_o2_caseg6_s021_2.txt");
    string dname3("../simulation/rep100_prop/simdata_TLP_100_100_0.85_o2_caseg6_s021_2.txt");
    
    string name3("../simulation/rep100_prop/moviesim100_100_0.85_o2_caseg6_s021_2.txt");
    MatrixXd movie=readgn(name3);
    string name4("../simulation/rep100_prop/usersim100_100_0.85_o2_caseg6_s021_2.txt");
    MatrixXd users=readgn(name4);
    
    string alphaname("../simulation/rep100_prop/alphasim_100_100_0.85_o2_caseg6_s021_2.txt");
    MatrixXd mualpha=readgn(alphaname);
    string betaname("../simulation/rep100_prop/betasim_100_100_0.85_o2_caseg6_s021_2.txt");
    MatrixXd mubeta=readgn(betaname);
    
    string alphatruename("../simulation/rep100_prop/alpha_true100_100_0.85_o2_caseg6_s021_2.txt");
    string betatruename("../simulation/rep100_prop/beta_true100_100_0.85_o2_caseg6_s021_2.txt");
    ...
    vector<vector<double>> bestX,bestZ,best_eta,best_y;
    double rho=2;
    ...
    /*for (int i=0; i<lambda1.size(); ++i) {
        ...
        int clu_beta=cal_cluster_no(mubeta.transpose());
    ...
    string pathAndNameL1tune("../simulation/rep100_prop/sim100_100_0.85_o2_caseg6_s021_2_40Omega_estvar_L1_tune_p1_3.txt");//tune in last is real tune
    string pathAndNameL1final("../simulation/rep100_prop/sim100_100_0.85_o2_caseg6_40Omega_estvar_L1_final_nonsep_new.txt");
    
    lambda1.resize(5);lambda1<<400,200,100,20,10;//20,10;//30;5,1;5,2;//5,1,0.1
    VectorXd lambda2(1);lambda2<<1;//<<1,0.1;//1,0.1;//,0.05; size penalty
    VectorXd lambda3(1);lambda3<<5;//5,1;//1,0.5; //the same as lambda1, fused penalty
    ...
    Cluster_mnl_p_ADMM_scale_para3 C;// here is start for L1
    ...
    vector<Omega_1rlv> rlv_s(rlv.size());
...
#pragma omp parallel for
    for (int i=0; i<rlv.size(); ++i) {
        ...
        rlv_s[i].item1=rlv[i].item1;
        rlv_s[i].item2=rlv[i].item2;
        rlv_s[i].userno=rlv[i].userno;
        rlv_s[i].firstin=rlv[i].firstin;
        rlv_s[i].secin=rlv[i].secin;
    }
    C.itemmore_idle=itemmore_idle;
    C.rlv_idle=rlv_idle;
    C.size_est_diag=size_est_diag;
    C.size_est_offdiag=size_est_offdiag;
    C.itemmore=itemmore;
    C.rlv=rlv_s;
    C.X.resize(rlv.size());
    for (int i=0; i<rlv.size(); ++i) {
        C.X[i].assign(size_est_offdiag[i],0);
    }
    C.Z=C.X;
    C.eta.resize(p+rlv.size());
    for (int i=0; i<p; ++i) {
        C.eta[i].assign(size_est_diag[i]*(size_est_diag[i]-1)/2,0);
    }
    cout<<"here"<<endl;
    ...
    /*nlayer=3;
     ...
     c=0.02;//0.1
     string pathAndNameTLPtune("../simulation/rep100_prop/sim100_100_0.85_o2_caseg6_s021_2_40Omega_estvar_TLP_tune_p1.txt");
     string pathAndNameTLPfinal("../simulation/rep100_prop/sim100_100_0.85_o2_caseg6_40Omega_estvar_TLP_final_nonsep_p1.txt");
    ...
    /*if(remove(trainname.c_str())!=0||remove(tunename.c_str())!=0||remove(testname.c_str())!=0||remove(traintunename.c_str())!=0
     ||remove(name3.c_str())!=0||remove(name4.c_str())!=0||remove("alphasim_100_100_0.85_o2_caseg6_s021_2.txt")!=0||remove("betasim_100_100_0.85_o2_caseg6_s021_2.txt")!=0
     ||remove(alphatruename.c_str())!=0||remove(betatruename.c_str())!=0||remove("Sigmatune100_100_0.85_o2_caseg6_s021_2.txt")!=0
     ||remove("Sigmatest100_100_0.85_o2_caseg6_s021_2.txt")!=0||remove("Cortrain100_100_0.85_o2_caseg6_s021_2.txt")!=0
     ||remove("Omega1_true100_100_0.85_o2_caseg6_s021_2.txt")!=0||remove("Omega2_true100_100_0.85_o2_caseg6_s021_2.txt")!=0
     ||remove("Omegais_true100_100_0.85_o2_caseg6_s021_2.txt")!=0) perror("Error deleting file\n");*/
