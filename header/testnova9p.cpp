...
int main(){
    //novariance first
    string trainname("../simulation/rep100_prop/trainsim100_100_0.8_o2_caseg6_s0101_2.txt");
    ...
    string tunename("../simulation/rep100_prop/tunesim100_100_0.8_o2_caseg6_s0101_2.txt");
    string testname("../simulation/rep100_prop/testsim100_100_0.8_o2_caseg6_s0101_2.txt");
    string traintunename("../simulation/rep100_prop/traintunesim100_100_0.8_o2_caseg6_s0101_2.txt");
    string dname2("../simulation/rep100_prop/simdata_100_100_0.8_o2_caseg6_s0101_2.txt");
    string dname3("../simulation/rep100_prop/simdata_TLP_100_100_0.8_o2_caseg6_s0101_2.txt");
    
    string name3("../simulation/rep100_prop/moviesim100_100_0.8_o2_caseg6_s0101_2.txt");
    MatrixXd movie=readgn(name3);
    string name4("../simulation/rep100_prop/usersim100_100_0.8_o2_caseg6_s0101_2.txt");
    MatrixXd users=readgn(name4);
    
    string alphaname("../simulation/rep100_prop/alphasim_100_100_0.8_o2_caseg6_s0101_2.txt");
    MatrixXd mualpha=readgn(alphaname);
    string betaname("../simulation/rep100_prop/betasim_100_100_0.8_o2_caseg6_s0101_2.txt");
    MatrixXd mubeta=readgn(betaname);
    
    string alphatruename("../simulation/rep100_prop/alpha_true100_100_0.8_o2_caseg6_s0101_2.txt");
    string betatruename("../simulation/rep100_prop/beta_true100_100_0.8_o2_caseg6_s0101_2.txt");
    ...
    vector<MatrixXd> testM=readgn_seq("../simulation/rep100_prop/Sigmatest100_100_0.8_o2_caseg6_s0101_2.txt",test.user.size());
    ...
    string pathAndNamenovariancetune("../simulation/rep100_prop/sim100_100_0.8_o2_caseg6_s0101_2_20Omega_tune_novariance_p1.txt");
    string pathAndNamenovariancefinal("../simulation/rep100_prop/sim100_100_0.8_o2_caseg6_20Omega_final_nonsep_novariance_p1.txt");
    //double lambda=10;
