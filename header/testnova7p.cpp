//this file want it to do 27 movie, 100 user, 0.8 missing, caseg5_s051~caseg5_s051 series of simulation for novariance, L1 and TLP
...
int main(){
    ...
    tstartall = time(0);
     ...
     //mualpha=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s051_2_300_alpha_novariance.txt");
     //mubeta=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s051_2_300_beta_novariance.txt");
     MatrixXd bestalphano=mualpha,bestbetano=mubeta;
     //mualpha=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s051_2_5_0.1_5_alpha.txt");
     //mubeta=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s051_2_5_0.1_5_beta.txt");
     ...
     //Omegais1=readgn_seq("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s051_2_5_0.1_5_Omega.txt",n);
     //current mualpha and mubeta are best from novariance
     //next is L1
     
     vector<MatrixXd> bestOmegais;
    
     //MatrixXd Omega1true=readgn("../simulation/rep100_prop/Omega1_true100_30_0.8_o2_caseg5_s051_2.txt");
     //MatrixXd Omega2true=readgn("../simulation/rep100_prop/Omega2_true100_30_0.8_o2_caseg5_s051_2.txt");
     ...
     //get_matricestoData(Omegais_true,"../simulation/rep100_prop/Omegais_true100_30_0.8_o2_caseg5_s051_2.txt");
...
//next TLP, bestalpha and bestbeta and bestOmegais are current best from L1//
 ...
 T.maxIter=3000;
 T.x=train;
 //T.realpha="simdata_100_30_0.8_o2_caseg5_s051_TLP_alpha.txt";
 T.movie=movie;
 T.users=users;
 ...
 //bestalpha=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s051_2_10_1_1_alpha.txt");//start from what gives the smaller wMSE
 //bestbeta=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s051_2_10_1_1_beta.txt");
 //bestu=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s051_2_10_1_1_u.txt");
 //bestu2=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s051_2_10_1_1_u2.txt");//
 //besttheta=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s051_2_10_1_1_theta.txt");
 //besttheta2=readgn("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s051_2_10_1_1_theta2.txt");
 //bestOmegais=readgn_seq("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s051_2_10_1_1_Omega.txt",n);
 //bestZis=readgn_seq("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s051_2_10_1_1_Z.txt",n);
 //bestUis=readgn_seq("../simulation/rep100_prop/simdata_100_30_0.8_o2_caseg5_s051_2_10_1_1_U.txt",n);
